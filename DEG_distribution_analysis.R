...
repeats = read.csv('/Users/alenakizenko/Documents/PhD/hydra_vulgaris_chrom/genome_annotation_all_repeats/hvulg_rptcrft_merged.rmerge_renamed_sorted.gff',
...
up_repeats = read.csv('/Users/alenakizenko/Documents/PhD/hydra_vulgaris_chrom/genome_annotation_all_repeats_deg/upregulated_gene_annotation.tsv',
                      stringsAsFactors = F, header = F, sep = '\t')
