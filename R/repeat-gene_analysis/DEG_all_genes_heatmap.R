...
up = read.csv('/Users/alenakizenko/Documents/PhD/project/hydra_vulgaris_chrom/diff_expression_regeneration/up_parsed.tsv',
              header = F, stringsAsFactors = F, sep = '\t')

colnames(up) = c('Gene', 'Time', 'DE')

down = read.csv('/Users/alenakizenko/Documents/PhD/project/hydra_vulgaris_chrom/diff_expression_regeneration/down_parsed.tsv',
                header = F, stringsAsFactors = F, sep = '\t')
...
all_repeats = read.csv('/Users/alenakizenko/Documents/PhD/project/hydra_vulgaris_chrom/genome_annotation_all_repeats/all_repeats_gene_annotation_filtered_dist.tsv',
...
all_repeats = subset(all_repeats, Repeats != 'Low' & Repeats != 'Simple'
                     & Repeats != 'Unknown')
...
all_repeats_rtpcrft = read.csv('/Users/alenakizenko/Documents/PhD/project/hydra_vulgaris_chrom/genome_annotation_all_repeats/hvulg_rptcrft_merged.rmerge_renamed_sorted.gff',
                   stringsAsFactors = F, header = F, sep = '\t')
...
up_down_05_3_6_12_24_48_melt = melt(up_down_05_3_6_12_24_48)
colnames(up_down_05_3_6_12_24_48_melt) = c('Repeat', 'Time', 'Value')
str(up_down_05_3_6_12_24_48_melt)
up_down_05_3_6_12_24_48_melt$Time = as.character(up_down_05_3_6_12_24_48_melt$Time)
...
boxplot_time = ggplot(up_down_05_3_6_12_24_48_melt, aes(Time, Value, color = `Regulation type`)) +
  ...
  theme_bw() +
  geom_text(aes(label = Repeat), check_overlap = TRUE, size = 3.3) +
  theme(plot.title = element_blank(),
        ...
        legend.background = element_rect(fill = 'gray88', color = 'gray55')) +
  labs(title = '',
       x = 'Regeneration stages', y = 'Ratio of transposons near DEG') +
...
ggsave(plot = boxplot_time, filename = '/Users/alenakizenko/Documents/PhD/project/pictures/violin_deg.tiff',
...
ggsave(plot = heatmap_up_down,
       filename = '/Users/alenakizenko/Documents/PhD/project/pictures/heatmap_up_down_stages.tiff',
...
ggsave(plot = pca, filename = '/Users/alenakizenko/Documents/PhD/hydra_vulgaris_chrom/pictures/pca_deg_rep.tiff',
       width = 10, height = 10, device = 'tiff')
