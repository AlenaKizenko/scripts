...
parse_repeat_r1_hvir = read.csv('/Users/alenakizenko/Documents/PhD/green_hydra_repeat_ann/round_1/parse_rep_land_rma1/hvir_genome_hm2_250116_renamed.fa.align.landscape.Div.Rname.tab', sep = '\t',
                           stringsAsFactors = F)
...
parse_repeat_r1_holig = read.csv('/Users/alenakizenko/Documents/PhD/hydra_oligactis/rma1/hydra_oligactis.fasta.align.landscape.Div.Rname.tab', sep = '\t',
...
parse_repeat_r1_hvul = read.csv('/Users/alenakizenko/Documents/PhD/hydra_vulgaris_chrom/rma1_replanscape/Hydra-v2b.fasta.align.landscape.Div.Rname.tab', sep = '\t',
                           stringsAsFactors = F, skip = 1, header = T)
...
plot_all_hydras_CR1 = ggplot(data=df_all_hydras, aes(variable, perc, fill = Species))+
  geom_bar(stat="identity", position = 'stack', alpha = .7, width = 1) +
  ...
  ggtitle('Amount of CR1 repeats in green and brown hydra genomes')

ggsave(plot = plot_all_hydras_CR1,
       filename = '/Users/alenakizenko/Documents/PhD/plot_all_hydras_CR1.tiff',
